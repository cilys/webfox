...
public class UserModel extends Model<UserModel> {
    ...
    public static int updateUserInfo(String userId, String pwd,
                                         String realName, String sex,
                                         String phone, String address,
                                         String idCard, String status, String userIdentify){
        ...
        if (!StrUtils.isEmpty(userIdentify)){
            um.set(SQLParam.USER_IDENTIFY, userIdentify);
        }
    ...
    public static Page<UserModel> getUsersByStatus(String status, int pageNumber,
        ...
        if (StrUtils.isEmpty(coumln)){
            coumln = SQLParam.CREATE_TIME;
        }
    ...
    @Override
    public UserModel removeNullValueAttrs() {
